...
public class PaldbLookupIntrospectHandler implements LookupIntrospectHandler
{
  ...
  private final PaldbLookupExtractorFactory factory;

  public PaldbLookupIntrospectHandler(PaldbLookupExtractorFactory factory)
  {
  ...
  public Response getKeys()
  {
    ...
    return Response.ok(reader.keys()).build();
  }
  ...
  {
    return Response.ok(ImmutableMap.of("version", "v0")).build();
  }
